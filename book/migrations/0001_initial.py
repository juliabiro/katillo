# Generated by Django 2.2.11 on 2020-03-28 18:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webpage', models.CharField(default='', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recept', models.ForeignKey(on_delete=None, to='book.Recept')),
            ],
        ),
        migrations.CreateModel(
            name='Hatas',
            fields=[
                ...
                ('korosztaly', models.ForeignKey(on_delete=None, to='book.Korosztaly')),
                ('recept', models.ForeignKey(on_delete=None, to='book.Recept')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('termeknev', models.CharField(default='', max_length=200)),
